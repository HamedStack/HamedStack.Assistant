...
public static class StringSimilarityExtensions
{
    ...
    /// <returns>A value between 0 and 1 representing the similarity. 1 indicates the strings are identical, and 0 indicates they are completely different.</returns>
    ...
    /// <summary>
    /// Filters an array of strings to return those that contain the search string with a similarity score above the specified threshold.
    /// </summary>
    ...
    /// <summary>
    /// Determines if the source string contains the search string with a similarity score above the specified threshold.
    /// </summary>
    /// <param name="search">The string to search for.</param>
    ...
    /// <returns>True if the source string contains the search string with a similarity score above the threshold, otherwise false.</returns>
    ...
    /// <summary>
    /// Filters an IEnumerable of strings to return those that contain the search string with a similarity score above the specified threshold.
    /// </summary>
    /// <param name="search">The string to search for.</param>
    ...
    /// <returns>A list of results containing each candidate string and its computed similarity score.</returns>
    ...
    /// <summary>
    /// Computes the most similar string from a list of strings to the given string using the specified similarity algorithm.
    /// </summary>
    /// <param name="source">The source string to compare.</param>
    /// <param name="candidates">A list of strings to compare against the source string.</param>
    /// <param name="similarityAlgorithm">The similarity algorithm to use. Defaults to Levenshtein.</param>
    ...
    /// <summary>
    /// Computes the least similar string from a list of strings to the given string using the specified similarity algorithm.
    /// </summary>
    /// <param name="source">The source string to compare.</param>
    /// <param name="candidates">A list of strings to compare against the source string.</param>
    /// <param name="similarityAlgorithm">The similarity algorithm to use. Defaults to Levenshtein.</param>
    ...
    /// <param name="first">The first string to compare.</param>
    /// <param name="second">The second string to compare.</param>
    /// <param name="similarityAlgorithm">The similarity algorithm to use for comparison. Default is Levenshtein.</param>
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown when an unsupported similarity algorithm is provided.</exception>
