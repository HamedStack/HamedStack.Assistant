...
namespace HamedStack.Assistant.Extensions.DirectoryInfoExtended;
...
public static class DirectoryInfoExtensions
{
        ...
        SearchOption searchOption)
    {
        ...
        {
            var outputFile = destDirName + file.FullName[obj.FullName.Length..];
        ...
        {
            var outputDirectory = destDirName + directory.FullName[obj.FullName.Length..];
