...
public static class CommandLineUtility
{
    ...
    /// <param name="timeout">
    /// Optional timeout in milliseconds after which the command execution will be halted.
    /// </param>
    /// <param name="shellPath">
    /// Optional path to the shell executable. By default, it uses "/bin/bash" for Unix/Mac and
    /// "cmd" for Windows.
    /// </param>
    /// <param name="shellArgs">
    /// Optional arguments for the shell executable. By default, it uses "-c" for Unix/Mac and "/c"
    /// for Windows to execute the command.
    /// </param>
    ...
    /// <returns>
    /// A <see cref="CommandResult"/> containing the output, error, and exit code of the executed
    /// command or null if execution failed or did not pass the outputCheck.
    /// </returns>
