...
/// <summary>
/// Generates unique, ordered ID numbers with the Snowflake algorithm. Each generated ID is based on
/// the current time, worker ID, datacenter ID, and sequence number.
/// Note: It is recommended to keep the generator as a singleton to avoid the possibility of
///       duplicate IDs. Multiple instances of the generator can lead to duplicate IDs.
/// </summary>
public class SnowflakeIdGenerator
{
    ...
    /// <param name="projectStartDate">
    /// The reference date for timestamp calculation. If not specified, the date will be set to
    /// January 1, 1970 (Unix epoch time).
    /// </param>
    /// <param name="sequenceBits">
    /// The number of bits used for the sequence number. Must be between 1 and 22, inclusive.
    /// </param>
    /// <exception cref="ArgumentException">
    /// Thrown when provided values are out of expected range.
    /// </exception>
    ...
    /// </summary>
    /// <remarks>This method uses the BASE62_CHARS constant to map numbers to characters.</remarks>
    ...
    /// <param name="removePadding">
    /// If set to <c>true</c>, removes the padding from the base64 string.
    /// </param>
