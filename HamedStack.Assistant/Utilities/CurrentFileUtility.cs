...
public static class CurrentFileUtility
{
    ...
    /// </summary>
    /// <param name="file">The path of the current file. This parameter is automatically populated by the compiler.</param>
    ...
    /// <summary>
    /// Computes the absolute path based on a relative path and the location of the currently executing source file.
    /// </summary>
    /// <param name="relative">The relative path to be combined with the current file directory.</param>
    /// <param name="file">The path of the current file. This parameter is automatically populated by the compiler.</param>
    /// <returns>The absolute path resulting from combining the given relative path with the current file directory.</returns>
