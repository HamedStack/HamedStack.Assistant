...
{
    /// <summary>
    /// Copies a file from a specified destination to a target location. 
    ...
    /// <exception cref="InvalidOperationException">Thrown when unable to determine the directory name for the target.</exception>
