...
public static class ThreadUtility
{
    ...
    /// If set to <c>true</c>, the created thread is marked as a background thread; otherwise, it's
    /// a foreground thread. The default is <c>false</c>.
    /// </param>
    ...
    /// A function that indicates when the action should stop repeating. If it returns <c>true</c>,
