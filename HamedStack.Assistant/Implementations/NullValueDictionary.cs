...
public class NullValueDictionary<TKey, TValue> : Dictionary<TKey, TValue>, INullValueDictionary<TKey, TValue> where TKey : notnull
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NullValueDictionary{TKey, TValue}"/> class with
    /// the default value for TValue.
    /// </summary>
    ...
    /// The value to use as the default when a key does not exist in the dictionary.
    /// </param>
    ...
    /// <summary>
    /// Gets or sets the value associated with the specified key. Returns the specified default
    /// value or the default for TValue if the key does not exist.
    /// </summary>
