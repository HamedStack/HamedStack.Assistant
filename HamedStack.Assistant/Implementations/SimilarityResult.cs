...
public class SimilarityResult
{
    ...
    /// <summary>
    /// Gets or sets the computed similarity score between the source string and the candidate
    /// string. The score is a value between 0 and 1, where 1 indicates the strings are identical,
